...
```{r div_plot, echo=FALSE, fig.cap="Fig.1 Diversity indices"}
...
```{r dom_plot, echo=FALSE, fig.cap="Fig.2 Dominent species"}
fig_domspp
```
...
```{r grassprop_plot, echo=FALSE, fig.height=3, fig.width=4}
fig_grassprop
```

```{r pfgprop_plot, echo=FALSE, fig.height=6, fig.width=4}
fig_pfgprop
```
