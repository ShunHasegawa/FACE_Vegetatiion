...
```{r pfgprop_plot, echo=FALSE, fig.cap="Fig.3 C4:C3 ratio. Black points depict mean values adjusted by Year0 values with 95% CI. Gray points depict observed values for each FACE ring.",fig.height=3, fig.width=3}
fig_c43
```
